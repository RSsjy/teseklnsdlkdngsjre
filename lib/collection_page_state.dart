...
class CollectionPageState extends State<CollectionPage> {
  ...
  final List<String> _dropdownItems = ['location', 'exp', 'updated'];
  String sortBy = 'location'; // Default sorting attribute
  bool isAscending = true; // Default sorting order
  bool isAlsoAscending = true; // Default sorting order
  ...
  StreamBuilder<QuerySnapshot> _buildStreamBuilder() {
    return StreamBuilder<QuerySnapshot>(
      stream: _firestore
          ...
          .orderBy(sortBy,
              descending: !isAscending) // Primary sorting attribute
          .orderBy('name',
              descending: !isAlsoAscending) // Secondary sorting attribute
          .snapshots(),
              ...
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    Text(exp == "2099-99"
                        ? 'Exp Date: N/A'
                        : 'Exp Date: $exp ($amountExpiring / $count)'),
...
void itemOptionsDialog(BuildContext context, DocumentSnapshot itemData,
  ...
  int itemAmountExpiring = itemData['amount expiring'] as int? ?? 0;
  int itemCount = itemData['count'] as int? ?? 0;
